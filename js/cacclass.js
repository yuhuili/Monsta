...
function Monsta() {
	...
	monstaStage = new createjs.Stage("myCanvas");
	...
	this.eatTest = function() {
		...
		if (this.bomb.hitTest(pt0.x, pt0.y)) { this.dragger.removeAllEventListeners();console.log("reset");setTimeout(this.resetStage, 50);}
